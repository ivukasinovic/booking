...
INSERT INTO lodging (id,address,details , image,rating,persons_number,category_id,type_id,city_id,agent_id) VALUES (4,'Tolstojeva 23','Stan, dvosoban','',4,1,1,1,4,2);
INSERT INTO lodging (id,address,details , image,rating,persons_number,category_id,type_id,city_id,agent_id) VALUES (5,'Andriceva 22','Nesto','',2,1,1,1,3,2);
INSERT INTO lodging (id,address,details , image,rating,persons_number,category_id,type_id,city_id,agent_id) VALUES (6,'Bulevar Oslobodjenja 7','NOVOO ,nove stvari vise detalja na telefon ..... xD','',4,4 ,1,2,1,2);
INSERT INTO lodging (id,address,details , image,rating,persons_number,category_id,type_id,city_id,agent_id) VALUES (7,'Bulevar Oslobodjenja 163','Starija ali ocuvana garsonjeraa','',3,2,1,1,2,2);
INSERT INTO lodging (id,address,details , image,rating,persons_number,category_id,type_id,city_id,agent_id) VALUES (8,'Karadjaordjeva 25','Garsonjera','',3,1,1,1,2,2);
INSERT INTO lodging (id,address,details , image,rating,persons_number,category_id,type_id,city_id,agent_id) VALUES (9,'Karadjaordjeva 17','Stan, dvosoban','',4,2,1,1,4,2);
INSERT INTO lodging (id,address,details , image,rating,persons_number,category_id,type_id,city_id,agent_id) VALUES (10,'Branka Radicevica 12','Nesto','',2,3,1,1,3,2);

-- password == username
INSERT INTO user (role, city, email, name, number, password_hash, surname, username, activated,adress) VALUES ('ADMIN', 'Novi Sad', 'admin@admin.com', 'Ivan', '0635569989', '$2a$10$7ijBqusWKMQ6uxLVeun3vegjZplPgkh.Pz30j6lwdaNvKXAvukqCa', 'Vukasinovic', 'admin', true,'' );
INSERT INTO user (role, city, email, name, number, password_hash, surname, username, activated,adress) VALUES ('AGENT', 'Beograd', 'agent@agent.com','Agent', '0641569989', '$2a$10$x/7XMH/SS5NBPwU397jdqeMAjEjEivniS.kHRsaTep9usVhZQ/TtK', 'Agentic', 'agent', true,'');
...
INSERT INTO user (role, city, email, name, number, password_hash, surname, username, activated,adress) VALUES ('USER', 'Beograd', 'mironikos94@gmail.com', 'Dejan', '0615565239', '$2a$10$ZQwvyTiGWlQ.KSQhmrYqsubwVZEF6rt2PV26jRItaU1Cm4.3Ldvsm', 'Stojkic', 'dejan', true,'Becejska 38');
INSERT INTO user (role, city, email, name, number, password_hash, surname, username, activated,adress) VALUES ('USER', 'Novi Sad', 'milanovicstefann@gmail.com', 'Stefan', '0645565239', '$2a$10$lofWCJkjm9LLkvEdCkp2Ru7vpnvIZhEp1qZVmFRD3dQbTe4/Hm1fa', 'Milanovic', 'stefan', true,'Celopecka 38');
INSERT INTO user (role, city, email, name, number, password_hash, surname, username, activated,adress) VALUES ('USER', 'Novi Sad', 'jovananovakovic404@gmail.com', 'Jovana', '0645565239', '$2a$10$lSUMYb88sLFEJgwtBKP/QeDmlzxsTRzjTyVDac4uBjxADCeJxaDBq', 'Novakovic', 'jovana', true,'Francuska 38');
INSERT INTO user (role, city, email, name, number, password_hash, surname, username, activated,adress) VALUES ('USER', 'Becej', 'ivan.becej@gmail.com', 'Ivan', '0645565239', '$2a$10$flvNoXrjcdzP6F6/1rMrJ.x2.Us7vda1.bqmfOF.25nVr5Zt9ZgoK', 'Vukasinovic', 'ivan', true,'Niska 38');

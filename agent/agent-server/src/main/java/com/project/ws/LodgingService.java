 ...
 * 
 */
@WebServiceClient(name = "LodgingService", targetNamespace = "http://bookingxml.com/soap-example", wsdlLocation = "http://localhost:8080/api/ws/lodging.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/api/ws/lodging.wsdl");
